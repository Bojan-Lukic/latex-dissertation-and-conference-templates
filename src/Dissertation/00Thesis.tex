\documentclass[12pt, a4paper, bibtotoc, numbers=noenddot, toc=chapterentrywithdots]{scrreprt}
...
\usepackage[nonumberlist,acronym,section=subsection]{glossaries}[=v4.46]
